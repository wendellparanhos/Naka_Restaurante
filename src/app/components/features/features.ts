...
export class Features implements AfterViewInit {
  ...
  features = [
    {
      ...
      title: 'Culinária Sofisticada',
      description: 'Pratos autorais que mesclam a tradição japonesa com técnicas contemporâneas.'
    },
    {
      ...
      description: 'Espaço elegante com iluminação intimista, ideal para celebrações e encontros.'
    },
    {
      icon: 'M21 5c-1.11-.35-2.33-.5-3.5-.5-1.95 0-4.05.4-5.5 1.5-1.45-1.1-3.55-1.5-5.5-1.5S2.45 4.9 1 6v14.65c0 .25.25.5.5.5.1 0 .15-.05.25-.05C3.1 20.45 5.05 20 6.5 20c1.95 0 4.05.4 5.5 1.5 1.35-.85 3.8-1.5 5.5-1.5 1.65 0 3.35.3 4.75 1.05.1.05.15.05.25.05.25 0 .5-.25.5-.5V6c-.6-.45-1.25-.75-2-.9zm-1 13.5c-1.1-.35-2.3-.5-3.5-.5-1.7 0-4.15.65-5.5 1.5V8c1.35-.85 3.8-1.5 5.5-1.5 1.2 0 2.4.15 3.5.5v11.5z',
      title: 'Adega Premium',
      description: 'Seleção curada de sakes importados, vinhos finos e drinks autorais exclusivos.'
    },
    {
      icon: 'M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z',
      title: 'Eventos Privados',
      description: 'Salas reservadas para reuniões de negócios, aniversários e comemorações.'
    },
    {
      ...
      description: 'Conveniência e segurança com nosso serviço de manobrista na porta.'
    },
    {
      ...
      description: 'Experiência Omakase guiada pelo chef com os ingredientes mais frescos do dia.'
    }
  ];
  ...
  ngAfterViewInit() {
    ...
    const elements = this.featuresSection.nativeElement.querySelectorAll('.feature-card');
